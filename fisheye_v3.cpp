...
{   
  ...
  get_ocam_model(&o, "calib_results_fisheye1.txt");
  //get_ocam_model(&o, "calib_results_fisheye2.txt");
  int i;
  ...
  src1 = imread("./test_fisheye1.jpg" );

  rotate_image_90n(src1, src1, 270);
 ...
 //imwrite("undistorted_perspective2.jpg",dst_persp);
