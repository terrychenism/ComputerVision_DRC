...
string cascadeName = "F:/Program Files/OpenCV248/opencv/sources/data/haarcascades/haarcascade_frontalface_alt.xml";
string nestedCascadeName = "F:/Program Files/OpenCV248/opencv/sources/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
...
//    string inputName;     
//    int mode;  
//	IplImage* standard2 = cvLoadImage("D:\\fruit\\2.jpg",CV_LOAD_IMAGE_GRAYSCALE);
//    char dir[256] = "D:\\fruit\\";
...
//		mdir = dir;
//
//		cout<<"Processing test samples in Class "<<i<<endl;
//		char id[5];
//		mdir.append("test\\");
//		_itoa(i,id,10);
//		mdir.append(id);
