...
main (int argc, char** argv)
{
  ...
  // pcl::io::loadPLYFile ("debri.ply", *target_cloud);
  pcl::PolygonMesh triangles;
  pcl::PointCloud<pcl::PointXYZ>::Ptr target_cloud (new pcl::PointCloud<pcl::PointXYZ>);
  pcl::io::loadPolygonFilePLY("valve.ply", triangles);
  pcl::fromPCLPointCloud2(triangles.cloud, *target_cloud);
  ...
  viewer_final->addPolygonMesh (triangles); 
